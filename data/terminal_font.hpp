...
glyph_t FNT_musc2 = { 0x43, 0xB3, 0x34, 0xCB, 0x86, 0x01 }; /* ( ) */
...
glyph_t FNT_c     = { 0x00, 0xE0, 0x44, 0x50, 0xE4, 0x00 }; /* (c) */
glyph_t FNT_d     = { 0x41, 0xF0, 0x44, 0x51, 0xF4, 0x00 }; /* (d) */
glyph_t FNT_e     = { 0x00, 0xE0, 0x44, 0x1E, 0xE4, 0x00 }; /* (e) */
glyph_t FNT_f     = { 0x06, 0x82, 0x78, 0x08, 0x82, 0x00 }; /* (f) */
glyph_t FNT_g     = { 0x00, 0xF0, 0x44, 0xD1, 0x13, 0x38 }; /* (g) */
glyph_t FNT_h     = { 0x10, 0xC4, 0x49, 0x92, 0x24, 0x01 }; /* (h) */
glyph_t FNT_i     = { 0x04, 0x40, 0x10, 0x04, 0x61, 0x00 }; /* (i) */
glyph_t FNT_j     = { 0x01, 0x60, 0x08, 0x82, 0x20, 0x31 }; /* (j) */
glyph_t FNT_k     = { 0x10, 0x24, 0x51, 0x18, 0x25, 0x01 }; /* (k) */
glyph_t FNT_l     = { 0x04, 0x41, 0x10, 0x04, 0x61, 0x00 }; /* (l) */
glyph_t FNT_m     = { 0x00, 0xA0, 0x55, 0x55, 0x14, 0x01 }; /* (m) */
glyph_t FNT_n     = { 0x00, 0xC0, 0x49, 0x92, 0x24, 0x01 }; /* (n) */
glyph_t FNT_o     = { 0x00, 0xE0, 0x44, 0x51, 0xE4, 0x00 }; /* (o) */
glyph_t FNT_p     = { 0x00, 0xE0, 0x45, 0x51, 0xE4, 0x41 }; /* (p) */
glyph_t FNT_q     = { 0x00, 0xF0, 0x44, 0x51, 0xF4, 0x04 }; /* (q) */
glyph_t FNT_r     = { 0x00, 0x60, 0x25, 0x08, 0xC2, 0x01 }; /* (r) */
glyph_t FNT_s     = { 0x00, 0xE0, 0x40, 0x4E, 0xE0, 0x00 }; /* (s) */
glyph_t FNT_t     = { 0x00, 0xE2, 0x21, 0x88, 0x4A, 0x00 }; /* (t) */
glyph_t FNT_u     = { 0x00, 0x20, 0x49, 0x92, 0xA5, 0x00 }; /* (u) */
glyph_t FNT_v     = { 0x00, 0x10, 0x46, 0x91, 0x42, 0x00 }; /* (v) */
glyph_t FNT_x     = { 0x00, 0x20, 0x49, 0x8C, 0x24, 0x24 }; /* (x) */
glyph_t FNT_y     = { 0x00, 0x20, 0x49, 0x92, 0x43, 0x60 }; /* (y) */
glyph_t FNT_z     = { 0x00, 0xE0, 0x09, 0x0C, 0xE4, 0x00 }; /* (z) */
