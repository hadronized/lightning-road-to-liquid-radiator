...
glyph_t FNT_0     = { 0x39, 0x14, 0xD5, 0x65, 0x13, 0x80 }; /* (0) */
...
glyph_t FNT_B     = { 0x79, 0x14, 0x5E, 0x45, 0x17, 0x80 }; /* (B) */
...
glyph_t FNT_N     = { 0x45, 0x95, 0x53, 0x45, 0x14, 0x40 }; /* (N) */
...
glyph_t FNT_X     = { 0x45, 0x12, 0x84, 0x29, 0x14, 0x40 }; /* (X) */
glyph_t FNT_a     = { 0x00, 0x03, 0x81, 0x3D, 0x13, 0xC0 }; /* (a) */
glyph_t FNT_b     = { 0x41, 0x07, 0x91, 0x45, 0x17, 0x80 }; /* (b) */
...
glyph_t FNT_j     = { 0x08, 0x01, 0x82, 0x08, 0x24, 0x8C }; /* (j) */
...
glyph_t FNT_t     = { 0x00, 0x87, 0x88, 0x20, 0xA1, 0x00 }; /* (t) */
glyph_t FNT_u     = { 0x00, 0x04, 0x92, 0x49, 0x62, 0x80 }; /* (u) */
glyph_t FNT_v     = { 0x00, 0x04, 0x51, 0x44, 0xA1, 0x00 }; /* (v) */
glyph_t FNT_x     = { 0x00, 0x04, 0x92, 0x31, 0x24, 0x80 }; /* (x) */
glyph_t FNT_y     = { 0x00, 0x04, 0x92, 0x48, 0xE1, 0x18 }; /* (y) */
glyph_t FNT_z     = { 0x00, 0x07, 0x82, 0x31, 0x07, 0x80 }; /* (z) */
