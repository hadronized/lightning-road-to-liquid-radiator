...
"float sweep(float d,float dl,float t){"
  "float a=80.*(mod(max(-1.,time-dl),6.92));" /* 6.82 */
  "float r=abs(d-a);"
  "return max(t-r,0.);"
"}"
"void main(){"
  ...
  "if(terrain!=0.){"
    ...
    "frag+=vec4(0.,0.,2.5,1.)*("
        "sweep(sweepDist,68.8,2.)"
       "+sweep(sweepDist,72.2071,6.)"
       "+sweep(sweepDist,69.2,2)"
       "+sweep(sweepDist,69.42,2.)"
       "+sweep(sweepDist,69.2583,2.)"
       "+sweep(sweepDist,69.8683,2.)"
       "+sweep(sweepDist,70.2864,2.)"
       "+sweep(sweepDist,71.1373,1.)"
       "+sweep(sweepDist,71.3557,1.)"
       "+sweep(sweepDist,71.5659,1.)"
       "+sweep(sweepDist,71.7982,1.)"
      ")*pow(atten,2);"
  "}else{"
    "frag=vec4(0.);"
  "}"
