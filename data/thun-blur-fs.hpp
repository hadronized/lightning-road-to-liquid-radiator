...
"void main(){"
  "vec2 uv=get_texco();"
  "float s=res.z*1.5;"
  "frag=texture2D(offtex,vec2(uv.x-s*10.,uv.y))*0.02"
      "+texture2D(offtex,vec2(uv.x-s*6.,uv.y))*0.05"
      ...
      "+texture2D(offtex,vec2(uv.x+s*2.,uv.y))*0.10"
      "+texture2D(offtex,vec2(uv.x+s*6.,uv.y))*0.05"
      "+texture2D(offtex,vec2(uv.x+s*10.,uv.y))*0.02;"
  "frag+=texture2D(offtex,vec2(uv.x,uv.y-s*10.))*0.02"
       ...
       "+texture2D(offtex,vec2(uv.x,uv.y+s*2.))*0.10"
       "+texture2D(offtex,vec2(uv.x,uv.y+s*6.))*0.05"
       "+texture2D(offtex,vec2(uv.x,uv.y+s*10.))*0.02;"
  "frag*=0.5;"
"}";
